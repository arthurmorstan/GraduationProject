...
$title = $_SESSION['add-news-data']['title'] ?? null;
$body = $_SESSION['add-news-data']['body'] ?? null;

unset($_SESSION['add-news-data']);
?>
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <?php if (isset($_SESSION['add-news'])) : ?>
              <div class="alert_message error">
                <p>
                  <?= $_SESSION['add-news'];
                  unset($_SESSION['add-news']);
                  ?>
                </p>
              </div>
            <?php endif ?>
              <form action="<?= ROOT_URL ?>admin-dashboard/add-news-logic.php" enctype="multipart/form-data" method="POST">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea id="tiny" class="form-control" style="height: 100px" name="body"></textarea>
                  </div>
                </div>
