...
if(isset($_POST['submit'])) {
        ...
        if($thumbnail['name']){
            ...
            if(in_array($extension, $allowed_files)) {
                ...
                if($thumbnail['size'] < 5000000) {
                    ...
                    $_SESSION['edit-news'] = "File ảnh không được lớn hơn 5mb";
                }
            }
            else {
    ...
    if (isset($_SESSION['edit-categories'])) {
        ...
        $query = "UPDATE news_categories SET title = '$title', description = '$description', thumbnail='$thumbnail_to_insert' WHERE id=$id LIMIT 1";
