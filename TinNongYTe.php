...
$featured_query = "SELECT * FROM posts WHERE is_featured = 1 AND categories_id = 1";
$featured_result = mysqli_query($connection, $featured_query);
$featured = mysqli_fetch_assoc($featured_result);

// show news from db
$recent_query = "SELECT * FROM posts WHERE categories_id = 1 ORDER BY date_time DESC LIMIT 4";
$recent_news = mysqli_query($connection, $recent_query);

// show recent news from db
$query = "SELECT * FROM posts WHERE categories_id = 1 ORDER BY date_time DESC";
            ...
            <div class="col-lg-8">
                ...
                <div class="row post-carousel-twoCol post-carousel">
                    <div class="post post-over-content col-md-6">
                        <div class="details clearfix">
                            <h4 class="post-title">
                                <a href="ThanhTuuYKhoa.php">Thành Tựu Y Khoa</a>
                            </h4>
                            <ul class="meta list-inline mb-0">
                                <li class="list-inline-item">
                                    <a href="#">Hoàng Duy</a>
