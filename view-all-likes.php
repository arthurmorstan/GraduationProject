...
$query3 = "SELECT * FROM posts WHERE categories_id = $id AND active = 1 ORDER BY likes DESC";
$most_likes_news = mysqli_query($connection, $query3);
        ...
        <div class="row gy-4">
            <div class="col-lg-8">
                <div class="section-header">
                    ...
                    <div class="dropdown">
                        <button>Tin Được Yêu Thích</button>
                        <?php while ($view_all = mysqli_fetch_assoc($view_all_result)) : ?>
                        <div class="content">
                            <a href="<?= ROOT_URL ?>view-all-views.php?id=<?= $view_all['id'] ?>">Tin Xem Nhiều</a>
                        </div>
                        <?php endwhile ?>
                    </div>
                </div>
                            ...
                            <div class="col-md-12 col-sm-6">
                                ...
                                <div class="post post-list clearfix">
                                    <div class="thumb rounded">
                                        <a href="<?= ROOT_URL ?>count_views-logic.php?id=<?= $most_likes['id'] ?>&slug=<?= $newss['slug'] ?>">
                                            <div class="inner">
                                    ...
                                    <div class="details">
                                        <?php
                                        $author_id = $most_likes['staff_uuid'];
                                        ...
                                        <h5 class="post-title">
                                            <a href="<?= ROOT_URL ?>count_views-logic.php?id=<?= $most_likes['id'] ?>&slug=<?= $most_likes['slug'] ?>">
                                                <?= $most_likes['title'] ?>
                                            </a>
                                        </h5>
                                        <p class="excerpt mb-0">
                                            <?= substr($most_likes['body'], 0, 300) ?>....
                                        </p>
                                    </div>
                                </div>
                            </div>
